...
public class Fraction implements INumber<Fraction> {
    ...
    /**
     * Ethan Gilles Prints a fraction object, by printing the numerator and
    ...
    /**
     * Ethan Gilles Takes a fraction object and adds another fraction object,
     * returning a new fraction object representing the sum
     * 
     * @param input - A fraction object to add to the selected fraction
     * @return result - A simplified fraction object that represents the two
    ...
    public Fraction plus(Fraction input) {
        ...
        int sumNumerator = (this.numerator * (commonDenominator / this.denominator))
                + (input.numerator * (commonDenominator / input.denominator));
...
//Coby Andersen
    /**
     * Subtracts another fraction from this fraction and returns the result as a new
     * fraction.
     * 
    ...
    /**
     * Mandy Ho Divides this fraction by another fraction and returns the result as
     * a new fraction.
     *
     * @param input The fraction to divide this fraction by.
     * @return A new fraction representing the result of the division.
     * @throws ArithmeticException If the input fraction has a numerator of zero
     *                             (division by zero)
     */
    ...
    /**
     * Nathaniel Serrano Implements multiply() method: Multiplies Fractions by
     * multiplying numerators together to create a new numerator and muliplying
     * denominators together to create a new denominator and creates a new fraction
     * with the new numerator and denominator.
     * 
     * @param input - a Fraction object
     * @return result - a Fraction object equal to the product of the input and the
     *         instantiated Fraction.
     */
    ...
    /**
     * Ethan Gilles Gives the greatest common divisor for two integers
     * 
     * @param input - two integers
     * @return result - an integer that represents the greatest common divisor of
     *         the two inputs.
     */
    ...
    /**
     * Ethan Gilles Gives the least common multiple of two integers
     * 
     * @param input - two integers
     * @return result - an integer that represents the least common multiple of two
     *         integers
     */
    ...
    /**
     * Ethan Gilles returns if two fractions are the same or not
     * 
    ...
    /**
     * Mandy Ho Sorts an array of fractions in ascending order using the insertion
     * sort algorithm.
     *
...
// Coby Andersen
     ...
     * @return The most frequent fraction in the array. If multiple fractions have
     *         the same highest frequency, the first one encountered in the array is
     *         returned.
     */
    ...
    /**
     * Nathaniel Serrano Implements printReverse method: Prints last Fraction in
     * array then creates a new array that is a copy of the input minus the last
     * item. This new array is then used as the input for the method's recursive
     * call on itself.
     * 
    ...
    public static void main(String[] args) {
        ...
        System.out.println("no changes made, testing branch commits");
        ...
        System.out.println(
                "Outputs show method functionality, these three fractions will be used in the following examples: ");
        ...
        /*
         * Ethan Gilles testing the plus method outputs show that the method is
         * functional at adding two fractions
         */
        ...
        System.out.println();
        /*
         * Ethan Gilles testing the minus method output shows that the method is
         * functional at subtracting two fractions
         */
        ...
        /*
         * Ethan Gilles testing the multiply method outputs show that the method is
         * functional at multiplying two fractions
         */
        ...
        /*
         * Ethan Gilles testing the divide method outputs show that the method is
         * functional at multiplying two fractions
         */
        ...
        /*
         * Ethan Gilles Testing for hasSameValue method Outputs show that the method is
         * functional to show two fractions with the same value
         */
        ...
        /*
         * Ethan Gilles Testing for findFrequent method Outputs show that the method is
         * functional to find the most frequent fraction in an array
         */
        ...
        // calling the find frequent method to find the most common fraction in the
        // array.
        ...
        /*
         * Nathaniel Serrano Testing for printReverse method Outputs show that the
         * method is functional to print a fraction array in reverse.
         */
